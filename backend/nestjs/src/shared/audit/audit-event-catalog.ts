...
export const AUDIT_EVENT_CATALOG = [
  ...
  auditEvent(
    ...
    "ops.store_action_plan",
    "store_ops",
    "Store action solution evidence was submitted for review.",
    "feature_audit",
  ),
  auditEvent(
    ...
    "ops.store_action_plan",
    "store_ops",
    "Store action solution evidence was resubmitted after correction.",
    "feature_audit",
  ),
  auditEvent(
    ...
    "ops.store_action_plan",
    "store_ops",
    "Store action solution evidence was approved by the Region Manager.",
    "feature_audit",
  ),
  auditEvent(
    ...
    "ops.store_action_plan",
    "store_ops",
    "Store action solution evidence was returned for correction.",
    "feature_audit",
  ),
  auditEvent(
