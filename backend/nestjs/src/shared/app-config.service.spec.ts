...
describe("AppConfigService", () => {
  ...
  it("allows each local role frontend as a default CORS origin outside production", () => {
    const config = createConfig({
      NODE_ENV: "development",
    });
  ...
  it("requires exactly one approved fixture digest when synthetic storage is enabled", () => {
    ...
    expect(() => createConfig(enabledStorage).photoMediaStorageConfiguration)
