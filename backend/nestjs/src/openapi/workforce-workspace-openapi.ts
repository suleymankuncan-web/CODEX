  ...
  document.components.schemas = {
    ...
    WorkforceWorkspaceStore: objectSchema(
      ["companyId", "companyName", "regionId", "regionName", "regionManagerName", "storeId", "storeCode", "storeName", "storeStatus", "norm", "active", "averageTenureDays", "gap", "shortageDays", "personnel", "personnelTotal", "personnelLimit", "personnelOffset", "personnelHasMore"],
      {
        ...
        storeStatus: { type: "string" }, norm: nullableNumber, active: integer(), turnoverRate: nullableNumber, averageTenureDays: nullableNumber, gap: nullableNumber,
    ...
    WorkforceWorkspaceHistoryRow: objectSchema(
      ["employeeId", "displayName", "positionName", "entryDate", "exitDate", "totalWorkingDays"],
      { employeeId: uuid(), displayName: { type: "string" }, positionName: { type: "string", nullable: true }, entryDate: { type: "string", format: "date" }, exitDate: { type: "string", format: "date", nullable: true }, totalWorkingDays: nullableInteger },
    ),
    ...
    WorkforceWorkspaceSummary: objectSchema(["totalStores", "activePersonnel", "shortageStores", "openPositions", "averageTenureDays", "turnoverRate"], {
      totalStores: integer(), activePersonnel: integer(), shortageStores: integer(), openPositions: { type: "number", minimum: 0 }, averageTenureDays: nullableNumber, turnoverRate: nullableNumber,
    }),
