...
async function generateOpenApi(): Promise<void> {
  ...
  applyStoreActionPlanOpenApi(document); applyChecklistCommandOpenApi(document); applySalesTargetIncentiveWorkspaceOpenApi(document); applyTargetWorkspaceOpenApi(document);
