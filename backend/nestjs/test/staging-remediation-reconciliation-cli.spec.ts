...
describe("staging remediation reconciliation CLI boundary", () => {
  // Trace: FR-02, FR-11, FR-12; NFR-01..04, NFR-07; AC-06, AC-07; EC-09..11.
  it.each([
...
function runCli(overrides: Partial<Record<string, string>>) {
  ...
  return spawnSync(
    process.execPath,
    ["-r", "ts-node/register", join(process.cwd(), "scripts", "staging-remediation-reconciliation.ts")],
