...
describe("POST /api/integrations/import-batches", () => {
  ...
  it("accepts assignment import batches and stages assignment rows", async () => {
    ...
    expect(dispatch).toHaveBeenCalledWith(
      ...
      { batchId: "batch-2" },
      expect.any(Function),
      { jobId: "import-batch-batch-2-initial", strictLocalJobId: "import-batch-batch-2-initial" },
    );
  ...
  it("accepts position import batches and stages position rows", async () => {
    ...
    expect(dispatch).toHaveBeenCalledWith(
      ...
      { batchId: "batch-2b" },
      expect.any(Function),
      { jobId: "import-batch-batch-2b-initial", strictLocalJobId: "import-batch-batch-2b-initial" },
    );
