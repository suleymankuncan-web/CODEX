...
description: Build responsive React dashboards for the separate event-studio project using TypeScript, shadcn/ui, TanStack Query, and Supabase. Do not use for HR Axis or Store Ops prototypes, dashboards, workbenches, checklist surfaces, or Admin/Store UI; those must use hr-axis-prototype-standard and hr-axis-ui-refactor.
---

# Building Frontend Dashboards

> Scope guard: this skill belongs to event-studio. For HR Axis / Store Ops UI,
> stop and use `hr-axis-prototype-standard` with `hr-axis-ui-refactor`.
