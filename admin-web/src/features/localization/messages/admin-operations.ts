...
export const adminOperationsTr = {
  ...
  'adminOperations.apiFailureEyebrow': 'Yerel API sinyali',
  'adminOperations.apiFailureTitle': 'Son API arıza snapshotı',
  'adminOperations.apiFailureCopy': 'Bu panel sadece bu browser oturumunda yakalanan sanitize edilmiş API failure ring buffer kaydını okur.',
  'adminOperations.apiFailureCount': '{count} kayıt', 'adminOperations.apiFailureStored': 'Ring buffer',
  'adminOperations.apiFailureSource': 'Kaynak', 'adminOperations.apiFailureSourceValue': 'window.__STORE_OPS_API_FAILURES__',
  'adminOperations.apiFailurePersistence': 'Kalıcılık', 'adminOperations.apiFailureLocalOnly': 'browser oturumu',
  'adminOperations.apiFailureBoundaryCopy': 'Provider, backend endpoint, DB kaydı veya alert delivery eklenmedi; bu yüzey app-level monitoring iddiası taşımaz.',
  'adminOperations.apiFailureQueueTitle': 'Son sanitize failure kayıtları',
  'adminOperations.apiFailureEmpty': 'Bu browser oturumunda yakalanan API failure yok.',
  'adminOperations.apiFailureMeta': '{method} / {status} / {category}', 'adminOperations.apiFailureRetryable': 'Retry olabilir',
  'adminOperations.apiFailureNotRetryable': 'Retry değil', 'adminOperations.apiFailureNetwork': 'network',
  'adminOperations.apiFailureQueryKeys': 'query: {keys}', 'adminOperations.apiFailureNoQueryKeys': 'query yok',
  'adminOperations.apiFailureRequestId': 'request: {requestId}', 'adminOperations.apiFailureNoRequestId': 'request id yok',
  'adminOperations.apiFailureReason': '{message}. Route {route}; {query}; {request}; {duration} ms; {time}.',
  ...
  'adminOperations.workflowSource.actionPlan': 'action plan',
...
export const adminOperationsEn: Record<keyof typeof adminOperationsTr, string> = {
  ...
  'adminOperations.apiFailureEyebrow': 'Local API Signal',
  'adminOperations.apiFailureTitle': 'Recent API failure snapshot',
  'adminOperations.apiFailureCopy': 'This panel only reads the sanitized API failure ring buffer captured in this browser session.',
  'adminOperations.apiFailureCount': '{count} records', 'adminOperations.apiFailureStored': 'Ring buffer',
  'adminOperations.apiFailureSource': 'Source', 'adminOperations.apiFailureSourceValue': 'window.__STORE_OPS_API_FAILURES__',
  'adminOperations.apiFailurePersistence': 'Persistence', 'adminOperations.apiFailureLocalOnly': 'browser session',
  'adminOperations.apiFailureBoundaryCopy': 'No provider, backend endpoint, DB record, or alert delivery was added; this surface does not claim app-level monitoring.',
  'adminOperations.apiFailureQueueTitle': 'Recent sanitized failure records',
  'adminOperations.apiFailureEmpty': 'No API failures were captured in this browser session.',
  'adminOperations.apiFailureMeta': '{method} / {status} / {category}', 'adminOperations.apiFailureRetryable': 'Retryable',
  'adminOperations.apiFailureNotRetryable': 'Not retryable', 'adminOperations.apiFailureNetwork': 'network',
  'adminOperations.apiFailureQueryKeys': 'query: {keys}', 'adminOperations.apiFailureNoQueryKeys': 'no query',
  'adminOperations.apiFailureRequestId': 'request: {requestId}', 'adminOperations.apiFailureNoRequestId': 'no request id',
  'adminOperations.apiFailureReason': '{message}. Route {route}; {query}; {request}; {duration} ms; {time}.',
