export const storeWorkforceTr = {
  ...
  'storeWorkforce.eyebrow': 'Personel kapsamı',
  'storeWorkforce.storeBadge': 'Mağaza kapsamı',
  'storeWorkforce.regionBadge': 'Bölge kapsamı',
  ...
  'storeWorkforce.regionDescription':
    'Bölge müdürü kendi kapsamındaki mağazaların personel durumunu burada izler; mağaza detayı aynı sayfada açılır.',
  'storeWorkforce.personnelScope': 'Personel kapsamı',
  ...
  'storeWorkforce.storePersonnelCopy':
    'Aktif personel, pozisyon ve kıdem bilgileri mağaza kapsamına göre bağlanacak.',
