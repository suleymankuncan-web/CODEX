export const storeKpisCommandTr = {
  ...
  'storeKpis.regionCommandScope': 'BM kapsamı',
  ...
  'storeKpis.regionAverageIncompleteCopy': 'Tüm kapsam dönmediği için ortalama gösterilmez.',
  'storeKpis.regionScopeBadge': 'Kapsam',
  'storeKpis.regionScopeTitle': 'Kapsam',
  'storeKpis.regionScopeCopy': '{stores} mağaza · {personnel} personel',
  'storeKpis.regionScopePersonnelUnavailable': '{stores} mağaza · personel kapsamı veri yok',
...
export const storeKpisCommandEn: Record<keyof typeof storeKpisCommandTr, string> = {
  ...
  'storeKpis.regionCommandScope': 'RM scope',
  ...
  'storeKpis.regionAverageIncompleteCopy': 'Average is hidden until the full scope is returned.',
  'storeKpis.regionScopeBadge': 'Scope',
  'storeKpis.regionScopeTitle': 'Scope',
  'storeKpis.regionScopeCopy': '{stores} stores · {personnel} personnel',
  'storeKpis.regionScopePersonnelUnavailable': '{stores} stores · personnel scope unavailable',
  ...
  'storeKpis.regionStoresCopy':
    'Each row is a store assigned to the region manager. Out-of-scope stores are not shown here.',
