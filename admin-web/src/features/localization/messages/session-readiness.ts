export const sessionReadinessTr = {
  ...
  'sessionReadiness.userId': 'Kullanıcı id',
  'sessionReadiness.companyIds': "Şirket id'leri",
  ...
  'sessionReadiness.employeeId': 'Personel id',
  ...
  'sessionReadiness.regionIdsLabel': "bölge id'leri:",
  'sessionReadiness.storeIdsLabel': "mağaza id'leri:",
} as const
...
export const sessionReadinessEn: Record<keyof typeof sessionReadinessTr, string> = {
  ...
  'sessionReadiness.bearerToken': 'Bearer token',
  'sessionReadiness.userId': 'User id',
  ...
  'sessionReadiness.notAvailable': 'n/a',
  'sessionReadiness.employeeId': 'Employee id',
  ...
  'sessionReadiness.regionIdsLabel': 'region ids:',
  'sessionReadiness.storeIdsLabel': 'store ids:',
}
