      ...
      <StoreSurfacePage ariaLabel={copy.aria} className="tw:max-w-[1180px] tw:gap-3">
        <header className="tw:flex tw:flex-wrap tw:items-end tw:justify-between tw:gap-3">
          ...
          <div className="tw:flex tw:flex-wrap tw:items-center tw:gap-2">
            ...
            <ChecklistCommandPeriodPicker locale={locale} period={period} onChange={(value: string) => { setPeriod(value); setRegionOffset(0); setStoreOffset(0); setOpenRegion(null) }} />
          </div>
        </header>
