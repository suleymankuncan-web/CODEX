...
export const targetCopy = {
  tr: {
    ...
    resetApprovalDraft: 'Eski degerlere don',
    adjustedStatus: 'Duzenlendi',
    ...
    approve: 'Onayla',
    approveAdjusted: 'Duzenleyerek onayla',
    approving: 'Onaylaniyor',
    approvalEditedNoteRequired: 'Duzenleme varsa karar notu zorunlu.',
    approvalPositiveTargets: 'Tum personel hedefleri sifirdan buyuk olmali.',
