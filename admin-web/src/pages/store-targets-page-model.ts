...
export const targetCopy = {
  tr: {
    ...
    description:
      'Magaza hedef dagitimi, onay bekleyen talepler ve personel hedef kapsami ayni ritimde okunur. Rolun aksiyonu net kalir; eksik hedef icin tahmin uretilmez.',
    ...
    allStores: 'Tum magaza kapsami',
    coverageRate: 'Kapsam orani',
    personnelCoverage: 'Personel kapsami',
    storeCoverage: 'Magaza kapsami',
    ...
    noPendingCopy: 'Secili donem ve kapsam icin bolge karari bekleyen hedef talebi bulunmuyor.',
    ...
    noApprovedCopy: 'Secili kapsam ve donemde onaylanan hedef talebi bulunmuyor.',
  ...
  en: {
    ...
    description:
      'Store target distribution, pending requests, and personnel target coverage are read in one rhythm. The active role stays clear; missing targets are never guessed.',
    ...
    totalPersonnel: 'Personnel in scope',
    ...
    coverageTitle: 'Target reference coverage',
    coverageCopy:
    ...
    noPendingCopy: 'No target request is waiting for region decision in the selected period and scope.',
    ...
    noApprovedCopy: 'No approved target request exists for the selected scope and period.',
