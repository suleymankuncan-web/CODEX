...
export function buildLinuxProofDockerArgs(archivePath, archiveSha256) {
  ...
  return [
    ...
    'no-new-privileges',
    '--tmpfs',
    '/workspace:rw,nosuid,nodev,size=512m,mode=0755,uid=1000,gid=1000',
    '--tmpfs',
    '/tmp:rw,nosuid,nodev,size=512m,mode=0700,uid=1000,gid=1000',
    '--tmpfs',
    '/test-tmp:rw,nosuid,nodev,exec,size=512m,mode=0700,uid=1000,gid=1000',
    '--tmpfs',
    '/var/lib:rw,nosuid,nodev,size=512m,mode=0755,uid=1000,gid=1000',
    '--env',
    'TMPDIR=/test-tmp',
    '--env',
