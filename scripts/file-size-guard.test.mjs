...
const oversizedBaseline = new Map([
  ...
  ['admin-web/src/pages/StoreKpiHighlightsPage.tsx', 1483],
  ...
  ['admin-web/src/pages/StoreRankingsPage.tsx', 1443],
  ...
  ['admin-web/src/pages/StoreChecklistsPage.tsx', 956],
  ...
  ['admin-web/src/styles/store-command-shell.css', 793],
  ...
  ['admin-web/src/features/localization/messages/store-home.ts', 662],
