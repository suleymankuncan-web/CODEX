...
const oversizedBaseline = new Map([
  ['backend/nestjs/src/openapi/generate-openapi.ts', 5255],
  ...
  ['admin-web/src/pages/StoreKpiHighlightsPage.tsx', 1457],
  ['backend/nestjs/src/modules/integration/application/materialization.service.ts', 1450],
  ['backend/nestjs/src/modules/integration/application/integration.service.ts', 1439],
  ...
  ['admin-web/src/pages/StoreRankingsPage.tsx', 1424],
  ...
  ['admin-web/src/styles/rankings-plum-table.css', 1240],
  ['backend/nestjs/src/modules/store-ops/application/snapshot.service.ts', 1195],
  ['admin-web/src/styles/store-checklists-command.css', 1194],
  ...
  ['admin-web/src/pages/store-my-performance-model.ts', 1099],
  ['admin-web/src/pages/AdminChecklistTemplatesPage.tsx', 1006],
  ['admin-web/src/styles/store-approvals-ledger.css', 989],
  ['admin-web/src/features/auth/AuthDashboardSections.tsx', 960],
  ['admin-web/src/pages/StoreChecklistsPage.tsx', 957],
  ...
  ['admin-web/src/pages/OperationsControlTowerPage.tsx', 1025],
