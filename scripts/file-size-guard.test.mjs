...
const oversizedBaseline = new Map([
  ['backend/nestjs/src/openapi/generate-openapi.ts', 5137],
  ...
  ['admin-web/src/pages/IntegrationDashboardPage.tsx', 1380],
  ...
  ['admin-web/src/pages/store-checklists-logic.ts', 697],
