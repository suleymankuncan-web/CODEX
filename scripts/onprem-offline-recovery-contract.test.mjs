...
test('ONP-5 operators encode the signed synthetic rehearsal boundaries', () => {
  ...
  assert.match(restore, /REASSIGN OWNED BY hr_axis_restore TO hr_axis_migrator/)
  assert.match(restore, /REASSIGN OWNED BY hr_axis_restore TO keycloak/)
  ...
  assert.match(restore, /repair_sql='GRANT hr_axis_migrator TO hr_axis_restore;[\s\S]*REASSIGN OWNED BY hr_axis_restore TO hr_axis_migrator;'/)
  assert.match(restore, /repair_sql='GRANT keycloak TO hr_axis_restore;[\s\S]*REASSIGN OWNED BY hr_axis_restore TO keycloak;'/)
