...
const storeOpsModuleGraphLimits = new Map([
  ...
  ['backend/nestjs/src/modules/store-ops/store-ops-photo-media.module.ts', { controllers: 1, providers: 10, exports: 1 }],
  ...
  [
    ...
    { imports: 1, controllers: 5, providers: 13, exports: 5 },
  ],
])
