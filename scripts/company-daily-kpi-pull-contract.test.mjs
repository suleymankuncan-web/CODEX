...
test('daily pull contract locks daily and range conversion and gsm formulas', () => {
  for (const phrase of [
    ...
    'Every successful sales day contributes its store sale-invoice numerator',
    'every successful footfall day contributes its store footfall denominator',
    'a missing component MUST NOT discard the other observed component.',
