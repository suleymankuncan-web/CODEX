...
3. Preserve the 12 July Region Manager cookie-session pass. The next safe B1
   bundle is either the other three persona sessions, rankings/profile scope,
   or reports/incentives readback. Preserve the 5 July mutation observations
   and do not rerun them only to improve documentation.
