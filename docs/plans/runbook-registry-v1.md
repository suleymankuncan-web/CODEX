...
| Close launch browser-session evidence gap | `docs/plans/security-launch-blocker-pr-train-v1.md`, `docs/evidence/readiness/2026-06-12-security-launch-blocker-pr-train-closeout.md`, `docs/evidence/readiness/2026-06-12-browser-session-staging-evidence-blocked.md` | Approved real staging provider session or controlled browser session, expected role/landing, seeded assigned and unassigned store inputs, and sanitized smoke authority | Sanitized cookie-session evidence or continued `blocked_external` note | Viewing/copying/pasting/logging/recording real raw secrets/tokens/cookies, provider config change, DB migration, role/scope semantic change, unapproved staging mutation, fake proof, or mixed-domain PR. |
