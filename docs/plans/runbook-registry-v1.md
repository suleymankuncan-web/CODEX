...
| Enable, verify, or roll back DG-4 Sentry delivery | `docs/runbooks/dg4-sentry-app-error-delivery-v1.md` | Sentry project, Render API/worker env boundary, Vercel staging env, and owner email destination | Sanitized API/worker/frontend event receipt, redaction result, release/environment labels, and rollback state | DSN appears in source/evidence, smoke is run outside controlled staging, or delivery is assumed without a receipt. |
