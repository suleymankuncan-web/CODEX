# Talep Merkezi Command Canvas parity

Deterministic production evidence covers the accepted 1440x900, 1024x768,
390x844 and 320x844 frames plus the Report Viewer company hierarchy.

`admin-web/e2e/store-approvals-parity-evidence.spec.ts` proves the real Store
