...
- P1 operator support work is execution-mapped in
  ...
  explicit.
- P2 product intelligence is execution-mapped in
  `docs/plans/p2-product-intelligence-execution-v1.md`; Store Personnel
...
- P1 operator/support implementation without source/owner clarity: diagnostic
  ...
  permission bypasses.
- P2 product-intelligence backlog: Daily Command Brief, Command Chain
