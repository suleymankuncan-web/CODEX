...
| Continue the post-DG2 staging findings | `docs/plans/post-dg2-staging-remediation-and-constraint-reentry-plan-v1.md`, `docs/plans/rem-2-owner-decision-packet-v1.md`, `docs/plans/staging-remediation-invariant-spec-v2.md`, `docs/plans/staging-remediation-row-authority-classifier-spec-v1.md`, and `docs/plans/staging-remediation-reconciliation-spec-v1.md` | V2 and classifier evidence keep ORG/assignment authority unresolved. REM-7 repository-only implementation is complete pending PR; disposable evidence makes TARGET the sole `eligible_zero` candidate, while exact-SHA staging evidence remains separate. Standing authorization removes repeated prompts but not factual safety or production boundaries. |
