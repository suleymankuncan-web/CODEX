...
| Continue the post-DG2 staging findings | `docs/plans/post-dg2-staging-remediation-and-constraint-reentry-plan-v1.md`, `docs/plans/rem-2-owner-decision-packet-v1.md`, `docs/plans/staging-remediation-invariant-spec-v2.md`, `docs/plans/staging-remediation-row-authority-classifier-spec-v1.md`, and `docs/plans/staging-remediation-reconciliation-spec-v1.md` | PR #962 merged REM-7 and its exact-SHA staging receipt is valid. TARGET is the sole `eligible_zero` family and may enter REM-8 preparation; ORG/assignment remain blocked. No DDL or correction is authorized. |
