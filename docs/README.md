...
| Modernize Store/Admin UI | `docs/process/product-experience-principles.md`, `docs/process/ui-surface-standard-v1.md`, and `docs/process/ui-surface-recipes-v1.md` | Product-quality standard plus concrete component, token, icon, copy, page-anatomy, and reusable page recipe rules. |
