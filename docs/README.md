...
| Review the completed post-DG2 staging remediation | `docs/plans/post-dg2-staging-remediation-and-constraint-reentry-plan-v1.md`, `docs/plans/rem-2-owner-decision-packet-v1.md`, `docs/plans/staging-remediation-invariant-spec-v2.md`, `docs/plans/staging-remediation-row-authority-classifier-spec-v1.md`, `docs/plans/staging-remediation-reconciliation-spec-v1.md`, `docs/plans/rem8-target-constraint-observation-and-rehearsal-spec-v1.md`, and `docs/plans/dbc5-target-duplicate-enforcement-spec-v1.md` | TARGET-only DB-C5 is exact-SHA verified in staging from PR #966; ORG/assignment families remain honestly blocked/excluded, production is excluded, and the plan is `completed_with_excluded_or_blocked_families`. |
...
| Modernize Store/Admin UI | `.agents/skills/hr-axis-prototype-standard/SKILL.md`, `docs/process/product-experience-principles.md`, `docs/process/ui-surface-standard-v1.md`, `docs/process/ui-surface-recipes-v1.md`, and `docs/process/store-admin-surface-standardization-v1.md` | Canonical Command Canvas prototype grammar plus product-quality, component, token, icon, copy, page-anatomy, reusable recipe, and production-translation rules. |
...
- `docs/evidence/readiness/2026-07-12-staging-rem8-target-constraint-observation-v1.md`
...
- `docs/plans/staging-remediation-invariant-spec-v2.md`
