...
| Continue the post-DG2 staging findings | `docs/plans/post-dg2-staging-remediation-and-constraint-reentry-plan-v1.md`, `docs/plans/rem-2-owner-decision-packet-v1.md`, `docs/plans/staging-remediation-invariant-spec-v2.md`, `docs/plans/staging-remediation-row-authority-classifier-spec-v1.md`, `docs/plans/staging-remediation-reconciliation-spec-v1.md`, and `docs/plans/rem8-target-constraint-observation-and-rehearsal-spec-v1.md` | PR #964 and exact-SHA REM-8A/8B receipts close TARGET observation/rehearsal. `rem_8c_not_required`; TARGET may enter DB-C5 after the evidence PR, while ORG/assignment remain blocked. No staging DDL has occurred. |
