# Decision and domain risk reference

Status: active
Shelf: operating reference
Use when: a task touches medium/high risk, architecture, prioritization or an irreversible boundary. Read the full applicable domain and decision loop.
