...
No-Go without repair or mutation. PR #952 merged REM-1A; PR #953 merged one owner-confirmed REM-1B run with stable 70 family hits, 72 source records, nine buckets, and unresolved distinct-person count. REM-2 locked TARGET, KPI, Norm Kadro, and assignment-region lifecycle semantics; all other owner decisions remain unset. DG1-C retirement remains usage-gated.
...
- Merged REM-1B evidence explains the stable 70 hits without mutation. `codex/rem-2-owner-decision-options` locks TARGET, month-end KPI ownership, Norm Kadro lifecycle, and assignment-region authority: active assignments follow the store manager portfolio while closed rows preserve period history. The nine KPI, two Norm Kadro, and three assignment hits remain unclassified pending lifecycle evidence. Separate history-preserving writers are still required. Other owner fields are UNSET; DB-CONSTRAINTS remains No-Go and no second run, DML, DDL, paid service, runtime change, or production operation is authorized.
