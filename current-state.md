...
- `ops.user_action_store_assignment` icin active unique index var; ancak `ops.user_role_assignment` icin active role assignment uniqueness su an DB seviyesinde degil, servis pre-check'ine dayaniyor.
- Genis user rollout oncesi role assignment active uniqueness icin nullable scope id'leri ve future-dated assignment davranisini netlestiren ayri migration/design slice gerekir.
