...
Next:
1. Continue the owner-approved eight-PR Command Canvas cutover in `docs/plans/checklist-command-canvas-exact-production-cutover-plan-v2.md`: P1A merged as PR #988; P2 is the active bounded full-period read slice; P1B starts from the merged P1A SHA; the preserved dirty P3 planner must not be reset or merged independently.
