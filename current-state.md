...
Next:
1. Execute the owner-approved eight-PR Command Canvas cutover in `docs/plans/checklist-command-canvas-exact-production-cutover-plan-v2.md`: P1A is behavior-preserving extraction; P1B waits for equivalence; the preserved dirty P3 planner must not be reset or merged independently.
