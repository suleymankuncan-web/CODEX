...
Bu planin ilk ve ikinci guvenli adimi uygulandi:
...
- `master-data-bootstrap.service.spec.ts` validation, read-model/readiness ve promotion safety testlerini tasimaya devam eder.
- Validation ve promotion safety tarafina dokunulmadi.

Siradaki mantikli adim: Kalan master-data service dosya boyutunu tekrar tartmak; gerek varsa yalnizca Bucket C read-model/readiness icin ayri onayli bir dilim yapmak. Validation ve promotion safety tarafina hala dokunmamak.
